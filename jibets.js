...
(async () => {
  ...
  {
    const targetPage = page;
    await targetPage.goto('https://jibets.casino/Menu/Live', {
...

  {
    const targetPage = page;
    await puppeteer.Locator.race([
      targetPage.locator('li:nth-of-type(2) > div.image-container > img'),
      targetPage.locator('::-p-xpath(//*[@id="root"]/div[1]/div[5]/div/div[2]/ul/li[2]/div[1]/img)'),
      targetPage.locator(':scope >>> li:nth-of-type(2) > div.image-container > img')
    ])
      .setTimeout(timeout)
